...
import Controlador.SolicitudBusiness;
...
public class ListarSolicitudes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      SolicitudBusiness solicitud = new SolicitudBusiness();
        ArrayList<Solicitud> solicitudes = null;
        solicitudes = solicitud.listarSolicitudes(0);
        request.getSession().setAttribute("sesion_solicitud", solicitudes);
